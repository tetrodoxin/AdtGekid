...
namespace AdtGekid.Tests
{
    public class SerializerTests
    {
        ...
        public void Deserialize()
        {
            ...
            using (var reader = new StreamReader("sample.xml", Encoding.UTF8))
            {
                                ...
                                new Meldung()
                                {
                                    ...
                                    Verlaeufe = new Verlauf[]
                                    {
                                        new Verlauf
                                        {
                                            ...
                                            Tod = new VerlaufTod { Sterbedatum = "11.11.2011", Tumorbedingt = JnuTyp.Ja, UrsachenIcdCodes = new Collection<string> {"C22.0"} },
